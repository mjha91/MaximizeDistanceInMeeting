...
if totalcombs > 100000:
    allcombs = [random.choices(coords,k=nseats) for rcount in range(100000)]
    print("Got 100k random sample")
...
for combs in allcombs: #combination of nseats   
    ...
    if counter%10000 == 0:
        print(counter/1000, "% of combinations done")
